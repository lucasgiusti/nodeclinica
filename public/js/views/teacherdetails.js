window.TeacherView = Backbone.View.extend({
    ...
    render: function () {
        ...
        var teacher = this.model.toJSON();

        $(this.el).html(this.template(teacher));
        ...
        html += '<select class="form-control" id="selstate" name="state" value="' + teacher.state + '" >';


        html += carregaEstados(_estadoscidades, teacher.state);
        ...
        html += '<div class="controls">';
        html += '<select class="form-control" id="selcity" name="city" value="' + teacher.city + '">';


        html += carregaCidades(_estadoscidades, teacher.state, teacher.city);
