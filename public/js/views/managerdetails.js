window.ManagerView = Backbone.View.extend({
    ...
    render: function () {
        ...
        html += carregaEstados(_estadoscidades, manager.state);
        ...
        html += carregaCidades(_estadoscidades, manager.state, manager.city);
    ...
    saveManager: function () {
        ...
        this.model.save(null, {
            success: function (model) {
                ...
                utils.showAlert('Success!', 'Gestor atualizado com sucesso', 'alert-success');
            },
